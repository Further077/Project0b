...
public class TestList {
	...
	public void testContainsAll() {
		...
		Integer [] testList1 = {33,77,44,55,66};
		Integer [] testList2 = {11,22,33};
		assertEquals(true,list.containsAll(Arrays.asList(testList1)));
		assertEquals(false, list.containsAll(Arrays.asList(testList2)));
	}
	...
	public void testAddAll() {
		...
		Integer [] testList = {33,77,44,77,55,77,66};
		list.addAll(Arrays.asList(testList));
		assertEquals(7, list.size());
	...
	public void testRemoveAll() {
		...
		// (without touching the assertions themselves)
		Integer [] testList = {33,44,55,66}; 
		list.removeAll(Arrays.asList(testList));
		assertEquals(3, list.size());
	...
	public void testRetainAll() {
		...
		// (without touching the assertions themselves)
		Integer [] testList = {77};
		list.retainAll(Arrays.asList(testList));
		assertEquals(3, list.size());
		assertEquals(Arrays.asList(77, 77, 77), list);
	}
